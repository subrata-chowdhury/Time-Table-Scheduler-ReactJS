export default function Cross({ fillColor = "#000", crossIconClickHandler = () => { } }) {
    return (<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={fillColor} onClick={crossIconClickHandler}>
