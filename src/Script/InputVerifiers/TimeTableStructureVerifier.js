export default function verifyTimeTableStructureInputs(timeTableStructureFieldValues, onError = () => { }) {
    ...
    if (!((breaksPerSemester instanceof Array) && breaksPerSemester.every((subarr) => (subarr instanceof Array) &&
        subarr.every((value) => (value <= timeTableStructure.periodCount))))) {
