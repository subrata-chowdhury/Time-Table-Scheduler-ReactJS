...
const Cards = ({ cardList = [], cardClassName = "", onCardClick = () => { }, onAddBtnClick = () => { }, canStayActiveMultipleCards = false, showEditBtn = false, onEditBtnClick = () => { }, onActive = () => { } }) => {
...
export const Card = memo(({ details = "Sample", className = "", active = false, onClick = () => { }, compressText = true, showEditBtn = false, onEditBtnClick = () => { } }) => {
    ...
    return ((showEditBtn ? (<div className="card-wrapper">
        <div className="edit-btn" onClick={() => { onEditBtnClick(details); }}><EditIcon /></div>
        {innerCard}
    </div>) : innerCard));
});
export const HorizentalCardsContainer = memo(({ cardList = [], className = "", onChange = () => { }, cardClassName = "", onCardClick = () => { }, compressText, showEditBtn = false, onEditBtnClick, canStayActiveMultipleCards = false }) => {
    ...
    return (<div className={'horizental-cards-container ' + className} onWheel={horizentalCardsOnWheelHandler}>
