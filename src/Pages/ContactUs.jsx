...
function MainComponents() {
    return (<div className="developers-container">
            <Developer picture={subrata} role="Frontend" developerName="Subrata Chowdhury" gitHubLink="https://github.com/Super7000" linkedInLink="https://www.linkedin.com/in/subrata7000" email="subratachowdhury7000@gmail.com"/>
            <Developer picture={srideep} role="Backend" developerName="Srideep Banerjee" gitHubLink="https://github.com/srideep-banerjee" linkedInLink="https://www.linkedin.com/in/srideep-banerjee-64b712251/" email="banerjee.srideep@gmail.com"/>
        </div>);
}
function Developer({ picture = subrata, role = "Frontend", developerName = "Name", gitHubLink = "https://github.com/Super7000", linkedInLink = "https://www.linkedin.com/in/srideep-banerjee-64b712251/", email = "" }) {
