            ...
            {student.length > 0 ? (
                <div style={{ padding: '2rem', border: '2px solid var(--borderColor)', borderRadius: '8px', margin: '0 auto', width: '90%', marginTop: '2rem', background: 'var(--containerColor)' }}>
                    ...
                    <div className='col-2 col-md-1'>
                        ...
                        <div style={{ marginBottom: '1.2rem' }}><div style={{ fontWeight: 600, marginBottom: '0.2rem', fontSize: '1.1rem' }}>Attendance:</div> <span style={{ fontWeight: 600, color: Number(student[0].attendance) >= 70 ? 'var(--greenText)' : 'rgb(255, 82, 43)' }}>{student[0].attendance}%</span></div>
                    </div>
                </div>
            ) : (
